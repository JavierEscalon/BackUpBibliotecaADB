    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <!-- Main Content -->
                <div id="content" class="d-flex flex-column" style="min-height: 100vh;">
                    ...
                    <!-- Begin Page Content -->
                    <div class="container-fluid flex-grow-1"> <!-- Se agregó flex-grow-1 para que el contenido ocupe el espacio disponible -->
                        <!-- Page Heading -->
            ...
            <!-- Page level plugins -->
            <script src="/BibliotecaAmigosDeDonBoscoWeb/assets/vendor/chart.js/Chart.min.js"></script>

            <!-- Page level custom scripts -->
            <script src="/BibliotecaAmigosDeDonBoscoWeb/assets/js/demo/chart-area-demo.js"></script>
            <script src="/BibliotecaAmigosDeDonBoscoWeb/assets/js/demo/chart-pie-demo.js"></script>
    </body>
</html>
