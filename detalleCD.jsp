            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Detalle del CD</h1>

                        <%
                            CD cd = (CD) request.getAttribute("cd");
                            if (cd != null) {
                        %>
                        <h5 class="card-title">Título: <%= cd.getTitulo() %></h5>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><strong>Editorial:</strong> <%= cd.getEditorial() %></li>
                            <li class="list-group-item"><strong>Autor:</strong> <%= cd.getAutor() != null ? cd.getAutor() : "No especificado" %></li>
                            <li class="list-group-item"><strong>Año de Publicación:</strong> <%= cd.getAñoPublicacion() != null ? cd.getAñoPublicacion() : "No especificado" %></li>
                            <li class="list-group-item"><strong>Ubicación Física:</strong> <%= cd.getUbicacionFisica() %></li>
                            <li class="list-group-item"><strong>Estado:</strong> <%= cd.getEstado() %></li>
                            <li class="list-group-item"><strong>Cantidad Total:</strong> <%= cd.getCantidadTotal() %></li>
                            <li class="list-group-item"><strong>Cantidad Disponible:</strong> <%= cd.getCantidadDisponible() %></li>
                            <li class="list-group-item"><strong>Descripción:</strong> <%= cd.getDescripcion() %></li>
                            <li class="list-group-item"><strong>Fecha de Adquisición:</strong> <%= cd.getFechaAdquisicion() %></li>
                            <li class="list-group-item"><strong>Código de Barras:</strong> <%= cd.getCodigoBarras() %></li>
                            <li class="list-group-item"><strong>Idioma:</strong> <%= cd.getIdioma() %></li>
                            <li class="list-group-item"><strong>Formato:</strong> <%= cd.getFormato() %></li>
                            <li class="list-group-item"><strong>Duración:</strong> <%= cd.getDuracion() %></li>
                            <li class="list-group-item"><strong>Contenido:</strong> <%= cd.getContenido() %></li>
                            <li class="list-group-item"><strong>Número de Pistas:</strong> <%= cd.getNumeroPistas() %></li>
                            <li class="list-group-item"><strong>Requisitos Mínimos:</strong> <%= cd.getRequisitosMinimos() %></li>
                        </ul>
                        <div class="mt-4 text-center">
                            <a href="ListarCDsServlet" class="btn btn-primary">Volver al Listado</a>
                        </div>
                        <% } else { %>
                        <p class="text-danger text-center">No se encontró el CD.</p>
                        <% } %>
