...
public class RegistrarRevistaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            // Establecer 'tipoMaterialId' en 2 para Revista
            revista.setTipoMaterialId(2);
            ...
            if (revistaDAO.insertarRevista(revista)) {
                ...
                request.setAttribute("mensajeError", "No se pudo registrar la revista.");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Redirigir al JSP de registro de revista
        request.getRequestDispatcher("registrarRevista.jsp").forward(request, response);
    }
    ...
    public String getServletInfo() {
        return "Servlet que permite registrar una nueva revista con validaciones.";
    }
}
