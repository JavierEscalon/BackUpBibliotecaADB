                ...
                <li class="nav-item">
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="libros.jsp">Libro</a>
                            <a class="collapse-item" href="obras.jsp">Obra</a>  
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Tesis</h1>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <a class="btn btn-success" href="ControladorTesis?accion=insertarTesis">Agregar Tesis</a>
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <%              
                                                ...
                                                List<Tesis> listaTesis = dao.listarTesis();
                                                Iterator<Tesis> iter = listaTesis.iterator();
                                                Tesis tesis=null;
                                                while(iter.hasNext()) {
                                                    tesis = iter.next();
                                            %>                            
                                                    <tr>
                                                        <td><%=tesis.getGrado() %></td>
                                                        <td><%=tesis.getInstitucion()%></td>
                                                        <td><%=tesis.getDirector()%></td>
                                                        <td><%=tesis.getArea()%></td>
                                                        <td><%=tesis.getDefensa()%></td>
                                                        <td><%=tesis.getPaginas()%></td>
                                                        <td><%=tesis.getTitulo()%></td>
                                                        <td><%=tesis.getDescripcion()%></td>
                                                        <td><%=tesis.getPublicacion()%></td> 
                                                        <td><%=tesis.getEditorial()%></td>
                                                        <td><%=tesis.getUbicacion()%></td>
                                                        <td><%=tesis.getCodigo()%></td>
                                                        <td><%=tesis.getIdioma()%></td>
                                                        <td><%=tesis.getCantidad()%></td>
                                                        <td><%=tesis.getAutor()%> <%=tesis.getAutor()%></td>
                                                        <td class="d-flex justify-content-between">
                                                            <a class="btn btn-primary"  href="ControladorTesis?accion=editarTesis&codigoIn=<%=tesis.getCodigo()%>">Editar</a>
                                                            <a class="btn btn-success"  href="ControladorTesis?accion=eliminarTesis&codigoIn=<%=tesis.getCodigo()%>">Eliminar</a>
                                                        </td>
                                                    </tr>
                                                <%}%>
                                        </tbody>
