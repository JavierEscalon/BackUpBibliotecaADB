...
<html>
    <head>
        ...
        <title>Editar Otros Documentos</title>
                    ...
                    <div class="container-fluid">
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-12 col-lg-12">
                                ...
                                <!-- Page Heading -->
                                <h1 class="h3 mb-2 text-gray-800">Editar Otros Documentos</h1>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form action="ActualizarOtroDocumentoServlet" method="POST" novalidate>
                                            <!-- Campo oculto para materialId -->
                                            <input type="hidden" name="materialId" value="<%= documento.getMaterialId() %>">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control <% if (errores != null && errores.containsKey("estado")) { %>is-invalid<% } %>" id="estado" name="estado" value="<%= documento.getEstado() != null ? documento.getEstado() : "" %>" required>
