            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Listado de CDs</h1>
                        <p>
                            <a class="btn btn-primary" href="RegistrarRevistaServlet">Crear un CD</a>
                        </p>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <%
                                    List<CD> listaCDs = (List<CD>) request.getAttribute("listaCDs");
                                    if (listaCDs != null && !listaCDs.isEmpty()) {
                                        for (CD cd : listaCDs) {
                                %>
                                    <tr>
                                        <td><%= cd.getTitulo() %></td>
                                        <td><%= cd.getEditorial() != null ? cd.getEditorial() : "No especificada" %></td>
                                        <td><%= cd.getAñoPublicacion() != null ? cd.getAñoPublicacion() : "No especificado" %></td>
                                        <td>
                                            <a href="DetalleCDServlet?id=<%= cd.getMaterialId() %>" class="btn btn-info btn-sm">Ver Detalles</a>
                                            <a href="ActualizarCDServlet?id=<%= cd.getMaterialId() %>" class="btn btn-warning btn-sm">Editar</a>
                                            <a href="EliminarCDServlet?id=<%= cd.getMaterialId() %>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar este CD?');">Eliminar</a>
                                        </td>
                                    </tr>
                                <%
                                        }
                                ...
                                %>
                                    <tr>
                                        <td colspan="4" class="text-center">No se encontraron CDs.</td>
                                    </tr>
                                <%
                                    }
                                %>
