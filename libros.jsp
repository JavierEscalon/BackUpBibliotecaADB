                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <a class="btn btn-success" href="ControladorLibro?accion=insertarLibro">Agregar Libro</a>
                                        ...
                                        <tbody>
                                            ...
                                            %>                            
                                                    <tr>
                                                        ...
                                                        <td><%=libro.getFormato()%></td>
                                                        <td><%=libro.getDimensiones()%></td>
                                                        <td><%=libro.getUbicacion()%></td>
                                                        <td><%=libro.getCodigo()%></td>
                                                        <td><%=libro.getIdioma()%></td>
                                                        <td><%=libro.getCantidad()%></td>
                                                        <td class="d-flex justify-content-between">
                                                                <a class="btn btn-primary" href="ControladorLibro?accion=editarLibro&isbn=<%= libro.getIsbn() %>">Editar</a>                                                                
                                                                <a class="btn btn-success" href="ControladorLibro?accion=eliminarLibro&codigo=<%= libro.getCodigo() %>">Eliminar</a>                                                                
                                                        </td>
                                                    </tr>
                                                <%}%>
                                        </tbody>
