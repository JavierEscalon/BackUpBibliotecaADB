                    ...
                    <div class="container-fluid">
                        ...
                        <h1 class="h3 mb-2 text-gray-800">Editar Libro</h1>
                         <%
                            ...
                            String elegidoIsbn = (String)request.getAttribute("lib");
                            Libro libro=(Libro)dao.lista(elegidoIsbn);
                        %>
                        <form action="ControladorLibro">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label" >ISBN</label>
                                <input name="textIsbn" type="text" class="form-control" value="<%=libro.getIsbn()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label"> Edición</label>
                                <input name="textEdicion" type="text" class="form-control" value="<%=libro.getEdicion()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label"> Título</label>
                                <input name="textTitulo" type="text" class="form-control" value="<%=libro.getTitulo()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label" >Descripción</label>
                                <input name="textDescripcion" type="text" class="form-control" value="<%=libro.getDescripcion()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Año de Publicación</label>
                                <input name="textPublicacion" type="text" class="form-control" value="<%=libro.getPublicacion()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Número de Paginas</label>
                                <input name="textPaginas" type="text" class="form-control" value="<%=libro.getPaginas()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Editorial</label>
                                <input name="textEditorial" type="text" class="form-control" value="<%=libro.getEditorial()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Autor</label>
                                <input name="textAutor" type="text" class="form-control" value="<%=libro.getAutor()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Formato</label>
                                <input name="textFormato" type="text" class="form-control" value="<%=libro.getFormato()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Dimensiones</label>
                                <input name="textDimensiones" type="text" class="form-control" value="<%=libro.getDimensiones()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Ubicación</label>
                                <input name="textUbicacion" type="text" class="form-control" value="<%=libro.getUbicacion()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Codigo de Barras</label>
                                <input name="textCodigo" type="text" class="form-control" value="<%=libro.getCodigo()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Idioma</label>
                                <input name="textIdioma" type="text" class="form-control" value="<%=libro.getIdioma()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Cantidad</label>
                                <input name="textCantidad" type="text" class="form-control" value="<%=libro.getCantidad()%>">
                            </div>
                            <input type="hidden" name="hiddenIsbn" value="<%=libro.getIsbn()%>">
