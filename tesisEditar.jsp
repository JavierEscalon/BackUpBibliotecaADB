            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Editar Tesis</h1>
                        <%
                            TesisDAO dao = new TesisDAO();
                            String elegidoCodigo = (String)request.getAttribute("tes");
                            Tesis tesis=(Tesis)dao.lista(elegidoCodigo);
                            System.out.println("Codigo: " + elegidoCodigo);
                        %>       
                        <form action="ControladorTesis">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label" >Grado Academico</label>
                                <input name="textGrado" type="text" class="form-control" value="<%=tesis.getGrado()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label"> Institución</label>
                                <input name="textInstitucion" type="text" class="form-control" value="<%=tesis.getInstitucion()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label"> Director</label>
                                <input name="textDirector" type="text" class="form-control" value="<%=tesis.getDirector()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label" >Area de Investigación</label>
                                <input name="textArea" type="text" class="form-control" value="<%=tesis.getArea()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Fecha de Defensa</label>
                                <input name="textDefensa" type="text" class="form-control" value="<%=tesis.getDefensa()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Número de Paginas</label>
                                <input name="textPaginas" type="text" class="form-control" value="<%=tesis.getPaginas()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Título</label>
                                <input name="textTitulo" type="text" class="form-control" value="<%=tesis.getTitulo()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Descripción</label>
                                <input name="textDescripcion" type="text" class="form-control" value="<%=tesis.getDescripcion()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Año de Publicación</label>
                                <input name="textPublicacion" type="text" class="form-control" value="<%=tesis.getPublicacion()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Editorial</label>
                                <input name="textEditorial" type="text" class="form-control" value="<%=tesis.getEditorial()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Ubicación</label>
                                <input name="textUbicacion" type="text" class="form-control" value="<%=tesis.getUbicacion()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Codigo de Barras</label>
                                <input name="textCodigo" type="text" class="form-control" value="<%=tesis.getCodigo()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Idioma</label>
                                <input name="textIdioma" type="text" class="form-control" value="<%=tesis.getIdioma()%>">
                            </div>                            
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Cantidad</label>
                                <input name="textCantidad" type="text" class="form-control" value="<%=tesis.getCantidad()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Autor</label>
                                <input name="textAutor" type="text" class="form-control" value="<%=tesis.getAutor()%>">
                            </div>
                                                
                            <input type="hidden" name="hiddenCodigo" value="<%=tesis.getCodigo()%>">
                            <button class="btn btn-primary w-100 py-2" type="submit" name="accion" value="actualizar">Actualizar</button>
                        </form>
                        <br />
                        <!-- /.container-fluid -->
