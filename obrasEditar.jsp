            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Editar Obra</h1>
                        <%
                            ObraDAO dao = new ObraDAO();
                            String elegidoCodigo = (String)request.getAttribute("obr");
                            Obra obra=(Obra)dao.lista(elegidoCodigo);
                        %>          
                        <form action="ControladorObra">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label" >Tipo de Obra</label>
                                <input name="textTipo" type="text" class="form-control" value="<%=obra.getTipo()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label"> Genero</label>
                                <input name="textGenero" type="text" class="form-control" value="<%=obra.getGenero()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label"> Formato</label>
                                <input name="textFormato" type="text" class="form-control" value="<%=obra.getFormato()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label" >Dimensiones</label>
                                <input name="textDimensiones" type="text" class="form-control" value="<%=obra.getDimensiones()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Título</label>
                                <input name="textTitulo" type="text" class="form-control" value="<%=obra.getTitulo()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Descripción</label>
                                <input name="textDescripcion" type="text" class="form-control" value="<%=obra.getDescripcion()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Año de Publicación</label>
                                <input name="textPublicacion" type="text" class="form-control" value="<%=obra.getPublicacion()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Editorial</label>
                                <input name="textEditorial" type="text" class="form-control" value="<%=obra.getEditorial()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Ubicación</label>
                                <input name="textUbicacion" type="text" class="form-control" value="<%=obra.getUbicacion()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Codigo de Barras</label>
                                <input name="textCodigo" type="text" class="form-control" value="<%=obra.getCodigo()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Idioma</label>
                                <input name="textIdioma" type="text" class="form-control" value="<%=obra.getIdioma()%>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Cantidad</label>
                                <input name="textCantidad" type="text" class="form-control" value="<%=obra.getCantidad()%>">
                            </div>   
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Autor</label>
                                <input name="textAutor" type="text" class="form-control" value="<%=obra.getAutor()%>">
                            </div>                               
                            <input type="hidden" name="hiddenCodigo" value="<%=obra.getCodigo()%>">
