...
<html>
    <head>
        ...
        <title>Detalle del Otros Documentos</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Detalle de Otros Documentos</h1>

                    <%
                        OtrosDocumentos documento = (OtrosDocumentos) request.getAttribute("documento");
                        if (documento != null) {
                    %>
                    <h5 class="card-title">Título: <%= documento.getTitulo() %></h5>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><strong>Tipo de Documento:</strong> <%= documento.getTipoDocumento() %></li>
                        <li class="list-group-item"><strong>Organización/Entidad:</strong> <%= documento.getOrganizacionEntidad() %></li>
                        <li class="list-group-item"><strong>Número de Serie:</strong> <%= documento.getNumeroSerie() %></li>
                        <li class="list-group-item"><strong>Formato:</strong> <%= documento.getFormato() %></li>
                        <li class="list-group-item"><strong>Dimensiones:</strong> <%= documento.getDimensiones() %></li>
                        <li class="list-group-item"><strong>Requisitos Especiales:</strong> <%= documento.getRequisitosEspeciales() %></li>
                        <li class="list-group-item"><strong>Editorial:</strong> <%= documento.getEditorial() %></li>
                        <li class="list-group-item"><strong>Año de Publicación:</strong> <%= documento.getAñoPublicacion() %></li>
                        <li class="list-group-item"><strong>Ubicación Física:</strong> <%= documento.getUbicacionFisica() %></li>
                        <li class="list-group-item"><strong>Estado:</strong> <%= documento.getEstado() %></li>
                        <li class="list-group-item"><strong>Cantidad Total:</strong> <%= documento.getCantidadTotal() %></li>
                        <li class="list-group-item"><strong>Cantidad Disponible:</strong> <%= documento.getCantidadDisponible() %></li>
                        <li class="list-group-item"><strong>Descripción:</strong> <%= documento.getDescripcion() %></li>
                        <li class="list-group-item"><strong>Fecha de Adquisición:</strong> <%= documento.getFechaAdquisicion() %></li>
                        <li class="list-group-item"><strong>Código de Barras:</strong> <%= documento.getCodigoBarras() %></li>
                        <li class="list-group-item"><strong>Idioma:</strong> <%= documento.getIdioma() %></li>
                    </ul>
                    <div class="mt-4 text-center">
                        <a href="ListarOtrosDocumentosServlet" class="btn btn-primary">Volver al Listado</a>
                    </div>
                    <% } else { %>
                    <p class="text-danger text-center">No se encontró el documento.</p>
                    <% } %>
