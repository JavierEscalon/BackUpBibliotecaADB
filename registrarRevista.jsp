                    ...
                    <div class="container-fluid">
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-12 col-lg-12">
                                ...
                                <!-- Page Heading -->
                                <h1 class="h3 mb-2 text-gray-800">Registrar una Nueva Revista</h1>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form action="RegistrarRevistaServlet" method="POST" novalidate>
                                            <!-- Campo 'titulo' -->
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control <% if (errores != null && errores.containsKey("estado")) { %>is-invalid<% } %>" id="estado" name="estado" value="<%= (revista.getEstado() != null) ? revista.getEstado() : "Disponible" %>" required>
