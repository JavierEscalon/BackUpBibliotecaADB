...
<html>
    <head>
        ...
        <title>Listado de Otros Documentos</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Listado de Otros Documentos</h1>
                        <p>
                            <a class="btn btn-primary" href="RegistrarRevistaServlet">Crear Otro Documento</a>
                        </p>
                            ...
                            <table class="table table-striped table-hover">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th>Organización/Entidad</th>
                                        <th>Acciones</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <%
                                        List<OtrosDocumentos> listaDocumentos = (List<OtrosDocumentos>) request.getAttribute("listaDocumentos");
                                        if (listaDocumentos != null && !listaDocumentos.isEmpty()) {
                                            for (OtrosDocumentos documento : listaDocumentos) {
                                    %>
                                        <tr>
                                            <td><%= documento.getTitulo() %></td>
                                            <td><%= documento.getTipoDocumento() %></td>
                                            <td><%= documento.getOrganizacionEntidad() %></td>
                                            <td>
                                                <a href="DetalleOtroDocumentoServlet?id=<%= documento.getMaterialId() %>" class="btn btn-info btn-sm">Ver Detalles</a>
                                                <a href="ActualizarOtroDocumentoServlet?id=<%= documento.getMaterialId() %>" class="btn btn-warning btn-sm">Editar</a>
                                                <a href="EliminarOtroDocumentoServlet?id=<%= documento.getMaterialId() %>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar este documento?');">Eliminar</a>
                                            </td>
                                        </tr>
                                    <%
                                            }
                                    ...
                                    %>
                                        <tr>
                                            <td colspan="4" class="text-center">No se encontraron documentos.</td>
                                        </tr>
                                    <%
                                        }
                                    %>
