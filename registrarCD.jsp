                    ...
                    <div class="container-fluid">
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-12 col-lg-12">
                                ...
                                <!-- Page Heading -->
                                <h1 class="h3 mb-2 text-gray-800">Registrar un Nuevo CD</h1>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form action="RegistrarCDServlet" method="POST" novalidate>
                                            <!-- Campo 'titulo' -->
                                            <div class="mb-3">
                                                <label for="titulo" class="form-label">Título:</label>
                                                <input type="text" 
                                                       class="form-control <% if (errores != null && errores.containsKey("titulo")) { %>is-invalid<% } %>" 
                                                       id="titulo" 
                                                       name="titulo" 
                                                       value="<%= cd.getTitulo() != null ? cd.getTitulo() : "" %>" 
                                                       required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" 
                                                       class="form-control <% if (errores != null && errores.containsKey("editorial")) { %>is-invalid<% } %>" 
                                                       id="editorial" 
                                                       name="editorial" 
                                                       value="<%= cd.getEditorial() != null ? cd.getEditorial() : "" %>" 
                                                       required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" 
                                                       class="form-control <% if (errores != null && errores.containsKey("autor")) { %>is-invalid<% } %>" 
                                                       id="autor" 
                                                       name="autor" 
                                                       value="<%= cd.getAutor() != null ? cd.getAutor() : "" %>" 
                                                       required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" 
                                                       class="form-control <% if (errores != null && errores.containsKey("anioPublicacion")) { %>is-invalid<% } %>" 
                                                       id="anioPublicacion" 
                                                       name="anioPublicacion" 
                                                       value="<%= cd.getAñoPublicacion() != null ? cd.getAñoPublicacion() : "" %>" 
                                                       required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" 
                                                       class="form-control <% if (errores != null && errores.containsKey("ubicacionFisica")) { %>is-invalid<% } %>" 
                                                       id="ubicacionFisica" 
                                                       name="ubicacionFisica" 
                                                       value="<%= cd.getUbicacionFisica() != null ? cd.getUbicacionFisica() : "" %>" 
                                                       required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" 
                                                       class="form-control <% if (errores != null && errores.containsKey("estado")) { %>is-invalid<% } %>" 
                                                       id="estado" 
                                                       name="estado" 
                                                       value="<%= cd.getEstado() != null ? cd.getEstado() : "Disponible" %>" 
                                                       required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" 
                                                       class="form-control <% if (errores != null && errores.containsKey("cantidadTotal")) { %>is-invalid<% } %>" 
                                                       id="cantidadTotal" 
                                                       name="cantidadTotal" 
                                                       value="<%= cd.getCantidadTotal() %>" 
                                                       required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" 
                                                       class="form-control <% if (errores != null && errores.containsKey("cantidadDisponible")) { %>is-invalid<% } %>" 
                                                       id="cantidadDisponible" 
                                                       name="cantidadDisponible" 
                                                       value="<%= cd.getCantidadDisponible() %>" 
                                                       required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" 
                                                       class="form-control <% if (errores != null && errores.containsKey("fechaAdquisicion")) { %>is-invalid<% } %>" 
                                                       id="fechaAdquisicion" 
                                                       name="fechaAdquisicion" 
                                                       value="<%= fechaAdquisicionStr %>" 
                                                       required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" 
                                                       class="form-control <% if (errores != null && errores.containsKey("codigoBarras")) { %>is-invalid<% } %>" 
                                                       id="codigoBarras" 
                                                       name="codigoBarras" 
                                                       value="<%= cd.getCodigoBarras() != null ? cd.getCodigoBarras() : "" %>" 
                                                       required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" 
                                                       class="form-control <% if (errores != null && errores.containsKey("idioma")) { %>is-invalid<% } %>" 
                                                       id="idioma" 
                                                       name="idioma" 
                                                       value="<%= cd.getIdioma() != null ? cd.getIdioma() : "" %>" 
                                                       required>
                                            ...
                                            <!-- Campo 'formato' (específico de CD) -->
                                            <div class="mb-3">
                                                <label for="formato" class="form-label">Formato:</label>
                                                <input type="text" 
                                                       class="form-control <% if (errores != null && errores.containsKey("formato")) { %>is-invalid<% } %>" 
                                                       id="formato" 
                                                       name="formato" 
                                                       value="<%= cd.getFormato() != null ? cd.getFormato() : "" %>" 
                                                       required>
                                            ...
                                            <!-- Campo 'duracion' (específico de CD) -->
                                            <div class="mb-3">
                                                <label for="duracion" class="form-label">Duración:</label>
                                                <input type="text" 
                                                       class="form-control <% if (errores != null && errores.containsKey("duracion")) { %>is-invalid<% } %>" 
                                                       id="duracion" 
                                                       name="duracion" 
                                                       value="<%= cd.getDuracion() != null ? cd.getDuracion() : "" %>" 
                                                       required>
                                            ...
                                            <!-- Campo 'contenido' (específico de CD) -->
                                            <div class="mb-3">
                                                <label for="contenido" class="form-label">Contenido:</label>
                                                <input type="text" 
                                                       class="form-control <% if (errores != null && errores.containsKey("contenido")) { %>is-invalid<% } %>" 
                                                       id="contenido" 
                                                       name="contenido" 
                                                       value="<%= cd.getContenido() != null ? cd.getContenido() : "" %>" 
                                                       required>
                                            ...
                                            <!-- Campo 'numeroPistas' (específico de CD) -->
                                            <div class="mb-3">
                                                <label for="numeroPistas" class="form-label">Número de Pistas:</label>
                                                <input type="number" 
                                                       class="form-control <% if (errores != null && errores.containsKey("numeroPistas")) { %>is-invalid<% } %>" 
                                                       id="numeroPistas" 
                                                       name="numeroPistas" 
                                                       value="<%= cd.getNumeroPistas() != null ? cd.getNumeroPistas() : "" %>" 
                                                       required>
                                            ...
                                            <!-- Campo 'requisitosMinimos' (específico de CD) -->
                                            <div class="mb-3">
                                                <label for="requisitosMinimos" class="form-label">Requisitos Mínimos:</label>
                                                <input type="text" 
                                                       class="form-control <% if (errores != null && errores.containsKey("requisitosMinimos")) { %>is-invalid<% } %>" 
                                                       id="requisitosMinimos" 
                                                       name="requisitosMinimos" 
                                                       value="<%= cd.getRequisitosMinimos() != null ? cd.getRequisitosMinimos() : "" %>" 
                                                       required>
                                            ...
                                            <!-- Botones de acción -->
                                            <button type="submit" class="btn btn-primary">Registrar CD</button>
